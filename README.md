...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b4cd83b4-3c79-4f9d-9761-7c9a96fb65e0
```

> `b4cd83b4-3c79-4f9d-9761-7c9a96fb65e0` is the password of the certificate, you can change it to any password you want.
