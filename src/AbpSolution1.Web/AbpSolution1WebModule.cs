...
public class AbpSolution1WebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                var fileName = Path.Combine(hostingEnvironment.ContentRootPath, "Certs", "certificate.pfx");
                serverBuilder.AddProductionEncryptionAndSigningCertificate(fileName, configuration["AuthServer:CertificatePassPhrase"]!);
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<AbpSolution1WebModule>("AbpSolution1.Web");
